...
int maxInUse = 1;    // Number of MAX7219's connected
MaxMatrix m(dIn, cs, clk, maxInUse);
byte buffer[10];
char incomebyte;
int scrollSpeed = 100;
char text[100] = "Washing Machine desgned by NGT   "; // Initial text message
int brightness = 15;
int count = 0;
char indicator;
void setup() {
  ...
  Serial.begin(9800); // Default communication rate of the Serial module
}
void loop() {
  // Printing the text
